...
class AdminController extends Controller
{
    ...
    //updated add_dish method where also english translation is added
    public function add_dish(Request $request)
    {
        ...
        $dish->dish_name_en = $request->input('dish-name-en');
        $dish->dish_description_en = $request->input('dish-description-en');
